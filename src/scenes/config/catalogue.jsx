                ...
                <Box m="20px">
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <ButtonBase
                            onClick={() => handleNavigation('/config/catalogue/zone-branches')}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <ButtonBase
                            onClick={() => handleNavigation('/config/catalogue/file-status')}
                            sx={{ width: '100%', height: '100%' }}
                            >
                            <Box
                                backgroundColor={colors.primary[400]}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <ButtonBase
                            onClick={() => handleNavigation('/config/catalogue/type-client')}
                            sx={{ width: '100%', height: '100%' }}
                            >
                            <Box
                                backgroundColor={colors.primary[400]}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <ButtonBase
                            onClick={() => handleNavigation('/config/catalogue/type-document')}
                            sx={{ width: '100%', height: '100%' }}
                            >
                            <Box
                                backgroundColor={colors.primary[400]}
