...
import { Box, useTheme, FormControl, FormControlLabel, FormLabel, RadioGroup, Radio, TextField, InputLabel, Select, MenuItem, Button, FormHelperText, Typography } from "@mui/material";
    ...
    >
      {({ values, errors, touched, handleBlur, handleChange, handleSubmit, handleReset, setFieldValue }) => (
        <form onSubmit={handleSubmit}>
          ...
          >
            <TextField hidden variant="filled" type="text" label="TipoSolicitud" value={values.tipo_solicitud} name="tipo_solicitud" sx={{ gridColumn: "span 2" }} />

            <TextField fullWidth variant="filled" type="text" label="RFC" onBlur={handleBlur} onChange={handleChange} value={values.rfc} name="rfc" error={!!touched.rfc && !!errors.rfc} helperText={touched.rfc && errors.rfc} sx={{ gridColumn: "span 2" }} />

            <TextField fullWidth variant="filled" type="text" label="Nombre/Razón Social" onBlur={handleBlur} onChange={handleChange} value={values.nombreRazonSocial} name="nombreRazonSocial" error={!!touched.nombreRazonSocial && !!errors.nombreRazonSocial} helperText={touched.nombreRazonSocial && errors.nombreRazonSocial} sx={{ gridColumn: "span 2" }} />
            ...
            <FormControl fullWidth sx={{ gridColumn: "span 2" }}>
              ...
              <RadioGroup aria-labelledby="demo-radio-buttons-group-label" name="cartaExpedicion" id="cartaExpedicion" value={values.cartaExpedicion} onBlur={handleBlur} onChange={handleChange}>
                <FormControlLabel value="SI" control={<Radio />} label="si" />
                <FormControlLabel value="NO" control={<Radio />} label="no" />
              </RadioGroup>
              {touched.actaConstitutiva && errors.actaConstitutiva && <FormHelperText style={{ color: "red" }}>{errors.actaConstitutiva}</FormHelperText>}
          ...
          >
            ...
            <TextField fullWidth variant="filled" type="text" label="Núm. Interior" value={values.numeroInterior} onBlur={handleBlur} onChange={handleChange} name="numeroInterior" error={!!touched.numeroInterior && !!errors.numeroInterior} helperText={touched.numeroInterior && errors.numeroInterior} sx={{ gridColumn: "span 2" }} />
